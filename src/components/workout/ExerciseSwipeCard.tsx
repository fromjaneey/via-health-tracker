...
import { Check, Info, AlertTriangle, Play, ChevronDown, ChevronUp, X } from "lucide-react";
...
const ExerciseSwipeCard = ({
  ...
  const rotate = useTransform(x, [-200, 0], [-8, 0]);
  const opacity = useTransform(x, [-200, -100, 0], [0.5, 0.8, 1]);
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-2 shrink-0">
            <span className="text-[10px] text-muted-foreground bg-muted px-2 py-0.5 rounded-full hidden sm:inline">← swipe to remove</span>
